                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                                ...
                                <JetDropdown align="right" width="48">
                                    <template #trigger>
                                        ...
                                        <span v-else class="inline-flex rounded-md">
                                            <button type="button" class="pc-nav inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-800  hover:text-gray-700 focus:outline-none transition">
                        ...
                        <div class="-mr-2 flex items-center sm:hidden">
                            <button class="sp-nav inline-flex items-center justify-center p-2 rounded-md text-gray-500 focus:outline-none focus:text-gray-500 transition" @click="showingNavigationDropdown = ! showingNavigationDropdown">
                                <svg
                                    class="h-6 w-6"
                                    stroke="currentColor"
                                    fill="none"
...
<style>
.bg-header {
    background-color: rgb(240,219,168);
}
.bg-body {
    background-color: rgb(255,249,238);
}
.pc-nav {
    background-color: rgb(230,167,138);
}
.sp-nav:hover {
    background-color: rgb(230,167,138);
}
